...
<div class="content-wrapper">
  <div class="container">
    <div class="row">
      <div class="col-md-12"><h4 class="page-head-line">New User</h4></div><!-- end col-md-12 -->
    </div><!-- end row -->
      ...
      <div class="row">
        ...
        <div class="col-md-12 no-padding-left no-padding-right">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"><h4>New User</h4></div><!-- end panel-heading -->
            ...
            <div class="panel-body">
              ...
              <div class="row form-area-with-inputs">
                  ...
                  <div class="form-group">
          		   		<label for="country" class="col-md-2">Password <span class="text-danger">*</span></label>
          		    	<div class="col-md-6">
                  ...
                  <div class="form-group">
          		   		<label for="country" class="col-md-2">Confirm Password <span class="text-danger">*</span></label>
          		    	<div class="col-md-6">
                  ...
                  <div class="form-group">
          		    	...
          		    	<div class="col-md-6">
          		    	  {!! Form::text('full_name',NULL,['class'=>'form-control full-name', 'id'=>'full-name']) !!}
          		    	</div>
          		  	</div><!-- end form-group -->
                  ...
                  <div class="form-group">
          		    	...
          		    	<div class="col-md-6">
          		    	  {!! Form::email('email',NULL,['class'=>'form-control email', 'id'=>'email']) !!}
          		    	</div>
          		  	</div><!-- end form-group -->
                  ...
                  <div class="form-group">
          		    	...
          		    	<div class="col-md-6">
                      {{ Form::select('role', ['' => 'Select Role', '0' => 'Administrator', '1'=> 'Operator', '2'=> 'Client'], NULL, ['class'=>'form-control role', 'id'=>'role']) }}
          		    	</div>
          		  	</div><!-- end form-group -->
                  ...
                  <div id="select-client">
                    ...
                    <div class="form-group">
            		    	...
            		    	<div class="col-md-6">
                        {{ Form::select('country_id', ['Select Country'], NULL, ['class'=>'form-control country-id', 'id'=>'country-id']) }}
            		    	</div>
            		  	</div><!-- end form-group -->
                    ...
                    <div class="form-group">
            		    	...
            		    	<div class="col-md-6">
                        {{ Form::select('store_id', ['Select Store'], NULL, ['class'=>'form-control store-id', 'id'=>'store-id']) }}
            		    	</div>
            		  	</div><!-- end form-group -->
...
<script type="text/javascript">
  ...
  $(function() {
    ...
    $("#submit").click(function(e) {
      ...
      {
        validationFailed = true;
        errors[count++] = "Password field is empty.";
      }

      if($.trim(confirm_password).length <= 0)
      {
        validationFailed = true;
        errors[count++] = "Confirm Password field is empty.";
      }
