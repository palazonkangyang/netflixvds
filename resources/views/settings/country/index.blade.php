          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                @if($data->editable == "")
                | <a href="/settings/delete/country/{{$data->id}}" class="action remove-item">Remove</a>
                @else
                | <span href="#" class="disabled-link" title="Stores are created under this country. You cannot remove it. Unless Stores have been deleted.">Remove</span>
                @endif
              </td>
            </tr>
            @endforeach
...
<script type="text/javascript">
  ...
  $(function() {
    ...
    $("#country-lists").on('click', '.remove-item', function() {
