...
<div class="content-wrapper">
  <div class="container">
    <div class="row">
      <div class="col-md-12"><h4 class="page-head-line">Edit Store</h4></div><!-- end col-md-12 -->
    </div><!-- end row -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"><h4>Edit Store</h4></div><!-- end panel-heading -->

            <div class="panel-body">

              <div class="row form-area-with-inputs">
  	            <div class="col-md-12">
                  {!! Form::open(array("url"=>"/stores/edit/" . $store->id)) !!}
                  ...
                  <div class="form-group">
                        ...
                        <option value="{{ $data->id }}" <?php if ($store->partner_id == $data->id) echo "selected"; ?>>{{ $data->partner_name }}</option>
                        @endforeach
                      </select>
          		    	</div>
          		  	</div><!-- end form-group -->
                  ...
                  <div class="form-group">
                        ...
                        <option value="{{ $data->id }}" <?php if ($store->country_id == $data->id) echo "selected"; ?>>{{ $data->country_name }}</option>
                        @endforeach
          		    	  </select>
          		    	</div>
          		  	</div><!-- end form-group -->
                  ...
                  <div class="form-group">
          		    	...
          		    	<div class="col-md-6">
          		    	  {!! Form::text('store_name', $store->store_name, ['class'=>'form-control store-name', 'id'=>'store-name']) !!}
          		    	</div>
          		  	</div><!-- end form-group -->
                  ...
                  <div class="form-group">
          		    	...
          		    	<div class="col-md-6">
                      {{ Form::textarea('description', $store->description, ['class'=>'form-control description', 'id'=>'description', 'size' => '30x5']) }}
          		    	</div>
          		  	</div><!-- end form-group -->
                  ...
                  <div class="form-group">
          		    	...
          		    	<div class="col-md-6">
                      {!! Form::text('contact_name', $store->contact_name, ['class'=>'form-control contact-name', 'id'=>'contact-name']) !!}
          		    	</div>
          		  	</div><!-- end form-group -->
                  ...
                  <div class="form-group">
          		    	...
          		    	<div class="col-md-6">
                      {!! Form::text('contact_no', $store->contact_no, ['class'=>'form-control contact-no', 'id'=>'contact-no']) !!}
          		    	</div>
          		  	</div><!-- end form-group -->
