...
<div class="content-wrapper">
  <div class="container">
    <div class="row">
      <div class="col-md-12"><h4 class="page-head-line">New Schedule</h4></div><!-- end col-md-12 -->
    </div><!-- end row -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"><h4>New Schedule</h4></div><!-- end panel-heading -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <table class="col-md-12 table-bordered table-striped table-condensed" id="store-lists">
                        ...
                        <tbody>
                          <tr>
                            <td colspan="3" id="no-data">No Data</td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <table class="col-md-12 table-bordered table-striped table-condensed" id="video-lists">
                        ...
                        <tbody>
                          <tr>
                            <td colspan="2" id="no-data">No Data</td>
                          </tr>
                        </tbody>
                      </table>
