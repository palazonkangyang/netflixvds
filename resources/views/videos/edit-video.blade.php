...
<div class="content-wrapper">
  <div class="container">
    <div class="row">
      <div class="col-md-12"><h4 class="page-head-line">Edit Video</h4></div><!-- end col-md-12 -->
    </div><!-- end row -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading"><h4>Edit Video Upload</h4></div><!-- end panel-heading -->
              ...
              <div class="row form-area-with-inputs">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      {!! Form::text('code', $video->code, ['class'=>'form-control code', 'id'=>'code']) !!}
                    </div>
                  </div><!-- end form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      {!! Form::text('title', $video->title, ['class'=>'form-control title', 'id'=>'title']) !!}
                    </div>
                  </div><!-- end form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      {{ Form::textarea('description', $video->description, ['class'=>'form-control description', 'id'=>'description', 'size' => '30x5']) }}
                    </div>
                  </div><!-- end form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      {!! Form::text('duration', $video->duration, ['class'=>'form-control duration', 'id'=>'duration']) !!}
                    </div>
                  </div><!-- end form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <select class="form-control" name="category_id" id="category-id">
                        ...
                        <option value="{{ $data->id }}" <?php if ($data->id == $video->category_id) echo "selected"; ?>>{{ $data->category_name }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div><!-- end form-group -->
