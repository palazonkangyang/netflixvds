      ...
      <div class="row">
        ...
        <div class="col-md-12 form-size no-padding-left no-padding-right" style="margin-bottom:20px;">
          ...
          <div class="col-md-2 no-padding-left">
            <input type="text" name="from_date" placeholder="From Date" value="{{ $from_date }}" class="form-control" id="from-date">
          </div><!-- end col-md-2 -->
          ...
          <div class="col-md-2 no-padding-left">
            <input type="text" name="to_date" placeholder="To Date" value="{{ $to_date }}" class="form-control" id="to-date">
          </div><!-- end col-md-2 -->
          ...
          <div class="col-md-3">
            <input type="text" name="search_title" placeholder="Keyword" value="{{ $search_title }}" class="form-control">
          </div><!-- end col-md-3 -->
